...
//            std::vector<std::string> singlePriceInfo = { priceData[i].source, priceData[i].openTime, priceData[i].open, priceData[i].last };
            responseVector.push_back({ priceData[i].openTime, std::to_string(priceData[i].open), std::to_string(priceData[i].last), std::to_string(priceData[i].high), std::to_string(priceData[i].low), std::to_string(priceData[i].volume), priceData[i].quoteVolume, std::to_string(priceData[i].change), std::to_string(priceData[i].prcntChange)});
        }
